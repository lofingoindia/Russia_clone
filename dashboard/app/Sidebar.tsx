...
const NavItem = ({ label, active = false, onClick }: NavItemProps) => (
    <div
        onClick={onClick}
        className={`px-4 py-2.5 rounded-lg text-sm font-medium flex items-center space-x-3 cursor-pointer transition-all duration-200 relative ${
            active 
    ...
    return (
        <aside className="w-64 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 flex flex-col shrink-0">
            <div className="h-16 flex items-center px-6 border-b border-gray-200 dark:border-gray-800">
                ...
                <h1 className="text-lg font-bold tracking-tight text-gray-900 dark:text-white">Russia App</h1>
            </div>

            <div className="flex-1 py-6 px-3 space-y-1 overflow-y-auto">
                <p className="px-4 text-[10px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3">Navigation</p>
                <NavItem
                    label="Dashboard"
            ...
            <div className="p-3 border-t border-gray-200 dark:border-gray-800 space-y-3">
                ...
                <button
                    onClick={onLogout}
                    className="w-full flex items-center justify-center space-x-2 py-2.5 rounded-lg text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors cursor-default"
                >
